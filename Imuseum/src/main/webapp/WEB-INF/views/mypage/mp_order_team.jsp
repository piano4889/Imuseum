					...
					<div class="container-fluid mt-5">
						...
						<div class="pt-2">
						  <ul class="row p-0" style="list-style:none;">
					  		...
					  		<li class="col-4 m-0 p-0" style="color:white; background-color:white;">
						  		<a>
							  		<button onclick="location.href='mp_order_team.do'" type="button" style="width:100%; color:white; background-color:black;" class="bt py-2 m-0">기업 및 단체 주문내역</button>
						  		</a>
					  		</li>
						  </ul>
						</div>
						...
						<table class="rvtable" style="width: 100%;">
							...
							<tr>
								<td colspan="4" style="padding:25px; text-align: center;">주문 내역이 없습니다.</td>
							</tr>
						</table>
						<!-- 주문 내역 리스트 끝 -->
						...
						<!-- 기타 안내사항 시작 -->
						<div class="my-4">
							<strong class="mb-2" style="font-size:20px;">기업 및 단체 구매 내역 안내</strong>
							<p style="color:gray">
								- 기업 및 단체 구매 신청을 통해 아트상품을 주문한 내역을 확인하실 수 있습니다.<br>
								- 기업 및 단체 구매 관련 안내는 FAQ에서 확인하실 수 있습니다.
							</p>
						</div>
						<!-- 기타 안내사항 끝 -->
					</div>
