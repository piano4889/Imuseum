			...
			<div class="row" style="padding-top: 50px;">
				...
				<div class="col-10">
					...
					<table class="rvtable" style="width: 100%;">
						...
						<tbody id="ajaxbody1">
							<c:forEach var="regdateSearch" items="${regdateSearch }">
								<tr style="text-align: center;">
									<td>${regdateSearch.regdate.substring(0, 11) }</td>
									<td>${regdateSearch.reservationIdx }</td>
									<td>${regdateSearch.id }</td>
									<td>${regdateSearch.groupValue }</td>
									<td>${regdateSearch.programTitle }</td>
									<td>${regdateSearch.datepicker }</td>
									<td>${regdateSearch.memberNumber }</td>
									<td><input type="submit" id="but1" value="삭제하기" onclick="deleteLearn('${regdateSearch.reservationIdx }')"></td>
								</tr>	
							</c:forEach>
						</tbody>
					</table>
