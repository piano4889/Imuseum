...
<body>
	...
	<div id="layout2">
		<div class="container2 notosanskr">
			<div class="box2">
				<c:forEach var="selectOld" step="1000" items="${selectOld }">
					<p class="now" style="font-weight: bold;">오래된순</p>
				</c:forEach>
				<ul class="new">
					<span style="margin-right: 1100px; color: #c3c4c7;">전체 <b style="color: black">${selectOldTotal }</b>건</span>
				...
				<c:choose>
					...
					<c:otherwise>
					<c:forEach var="selectOld" items="${selectOld }">
						<div id="click_area" class="click_area"><a href="getLearn.do?learnIdx=${selectOld.learnIdx }">
							<div class="left">
								<ul>
									<li><img src="${pageContext.request.contextPath}/learnImage/${selectOld.fileName }" width="630px" height="400px" /></li>
								</ul>
							</div>
							<div class="right">
								<div style="display: black; margin-top: 30px; margin-bottom: 20px;">
									<c:if test="${selectOld.educationNum == 0 }">
									...
									<c:if test="${selectOld.educationNum == 1 }">
									...
									<c:if test="${selectOld.educationNum == 2 }">
									...
									<c:if test="${selectOld.placeNum == 0 }">
									...
									<c:if test="${selectOld.placeNum == 1 }">
								...
								<span style="display:block; margin-top: 10px; font-size: 30px; font-weight: bold;">${selectOld.title }</span><br>
								<span style="font-size: 16px; color: #c3c4c7;">${selectOld.subtitle }</span>
								<table style="width: 600px; ">
								
									<tr>
										<td>교육 날짜</td>
										<td>${selectOld.regdate1.replaceAll("/","-") } ~ ${selectOld.regdate2.replaceAll("/","-") }</td>
									</tr>
									<tr>
										<td>장소</td>
										<td>${selectOld.place }</td>
									</tr>
									<tr>
										<td>정원</td>
										<td>${selectOld.memberNumber }</td>
									</tr>
									<tr>
										<td>교육시간</td>
										<td>${selectOld.educationTimeNum }, ${selectOld.educationTime }</td>
									</tr>
									<tr>
										<td>요금</td>
										<td>${selectOld.fee }</td>
