...
<body>
	...
	<div class="container-fluid">
		<div class="container">
			<div class="cate">
				<ul class="cate nav justify-content-center" style="padding-top:40px;">
				  ...
				  <li class="nav-item">
				    <a class="nav-link active" id="program" aria-current="page" href="#" onclick="location.href='deNotice.do'" style="color:gray;">디뮤지엄</a>
				  </li>  
				  <li class="nav-item">
				  ...
				  <li class="nav-item">
				    <a class="nav-link active" id="location" aria-current="page" href="#" onclick="location.href='muNotice.do'" style="color:black;">뮤지엄샵</a>
				  </li>
				</ul>
			</div>	
		</div>
		...
		<div class="container mt-5">
			<div class="noticeCount">총 &nbsp;<b>0</b>건</div>
			<hr>
			<div>
				<table style="line-height:70px; margin-bottom:200px; border-bottom:1px solid lightgray;">
				<c:choose>
					<c:when test="${empty muNotice }">
						<div style="text-align: center; font-size: 2em; padding:100px;">작성된 공지사항이 없습니다.</div>
					</c:when>
					<c:otherwise>
						<c:forEach var="muNotice" items="${muNotice }">
							<tr>
								<td>${muNotice.noNum }&nbsp;|&nbsp;${muNotice.noCategory }</td>
							</tr>
							<tr style="border-bottom:1px solid lightgray;">
								<td>
									<div>
										<span style="font-size:1.5em;">${muNotice.noTitle }</span>
										<span style="font-size:0.7em; float:right; margin-left:400px;">${muNotice.noDate }</span>
									</div>
								</td>
							</tr>
						</c:forEach>
