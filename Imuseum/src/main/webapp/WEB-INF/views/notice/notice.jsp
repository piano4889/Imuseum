...
<body>
	...
	<div class="container-fluid">
		<div class="container">
			<div class="cate">
				<ul class="cate nav justify-content-center" style="padding-top:40px;">
				  <li class="nav-item">
				    <a class="nav-link active" id="all" aria-current="page" href="#" onclick="location.href='allNotice.do'" style="color:black;">전체</a>
				  </li> 
				  <li class="nav-item">
		...
		<div class="container mt-5">
			<div class="noticeCount">총 &nbsp;<b>6</b>건</div>
			<hr>
			<div>
				<table style="line-height:70px; margin-bottom:200px; border-bottom:1px solid lightgray;">
				<c:choose>
					<c:when test="${empty allNotice }">
						<div style="text-align: center; font-size: 2em;">작성된 공지사항이 없습니다.</div>
					</c:when>
					<c:otherwise>
						<c:forEach var="allNotice" items="${allNotice }">
							<tr>
								<td>${allNotice.noNum }&nbsp;|&nbsp;${allNotice.noCategory }</td>
							</tr>
							<tr style="border-bottom:1px solid lightgray;">
								<td>
									<div>
										<span style="font-size:1.5em;" onclick="location.href='notice_detail.do'">${allNotice.noTitle }</span>
										<span style="font-size:0.7em; float:right; margin-left:400px;">${allNotice.noDate }</span>
									</div>
								</td>
							</tr>
						</c:forEach>
