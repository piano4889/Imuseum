		...
		<div class="container">
			<div class="cate">
				<ul class="cate nav justify-content-center" style="padding-top:40px;">
				  ...
				  <li class="nav-item">
				    <a class="nav-link active" id="reservation" aria-current="page" href="#" onclick="location.href='daeNotice.do'" style="color:black;">대림미술관</a>
				  </li>
				  <li class="nav-item">
		...
		<div class="container mt-5">
			...
			<div>
				...
				<c:choose>
					...
					<c:otherwise>
						<c:forEach var="daeNotice" items="${daeNotice }">
							<tr>
								<td>${daeNotice.noNum }&nbsp;|&nbsp;${daeNotice.noCategory }</td>
							</tr>
							<tr style="border-bottom:1px solid lightgray;">
								<td>
									<div>
										<span style="font-size:1.5em;">${daeNotice.noTitle }</span>
										<span style="font-size:0.7em; float:right; margin-left:400px;">${daeNotice.noDate }</span>
									</div>
								</td>
							</tr>
						</c:forEach>
