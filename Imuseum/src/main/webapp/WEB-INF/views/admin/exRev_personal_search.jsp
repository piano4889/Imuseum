	...
	<div class="row" style="padding: 0; margin: 0;">
		<div class="col-8 offset-2">
			<div class="row" style="padding-top: 50px;">
				...
				<div>
					<table border style="width: 100%; height:50px; text-align: center; cursor: pointer;">
						<tr style="font-size: 1.2em;">
							<td onclick="location.href='exRevPersonal.do'"
								style="background-color: black; color: white;">
							개인예매
							</td>
							<td onclick="location.href='exRevTeam.do'">
							단체예매
							</td>
						</tr>
					</table>
				...
				<p style="font-size: 0.8em; color: gray">총 <b style="color: black;">${list.size()}</b> 건</p>
				<table class="rvtable" style="width: 100%; font-size: 0.9em;">
					...
					<tr style="text-align: center;" id="disppp" class="js-load">
				...
				<%
					int cancle = (Integer)pageContext.getAttribute("cancle");
					int totalp = totalprice - cancle;
					DecimalFormat decFormat = new DecimalFormat("###,###");
					String printtotal = decFormat.format(totalprice); 
					String printtotcan = decFormat.format(totalp); 
				%>
