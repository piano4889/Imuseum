	...
	<div class="row" style="padding: 0; margin: 0;">
		<div class="col-8 offset-2">
			<div class="row" style="padding-top: 50px;">
				...
				<p style="font-size: 0.7em; color: gray">총 <b style="color: black;">${page.totalRecord}</b> 건</p>
				...
				<ul class="pagination justify-content-center pb-2">
		   			<!-- 이전 -->
		  		 		<li class="page-item">
		  		 			...
		  		 			<c:if test="${page.nowPage != 1 }">
							<a href="learnRevPersonal.do?page=${page.nowPage - 1 }" class="page-link"><i class="bi bi-chevron-left"></i></a>
						</c:if>	
						...
						<c:if test="${pageNo != page.nowPage }">
							<li class="page-item">
									<a href="learnRevPersonal.do?page=${pageNo }" class="page-link">${pageNo }</a>
		   					</li>
						</c:if>
						</c:forEach>
		   			<!-- 다음 -->
			   			<li class="page-item">
			   				<c:if test="${page.nowPage < page.totalPage }">
										<a href="learnRevPersonal.do?page=${page.nowPage + 1 }" class="page-link"><i class="bi bi-chevron-right"></i></a>
							</c:if>
							<c:if test="${page.nowPage >= page.totalPage }">
