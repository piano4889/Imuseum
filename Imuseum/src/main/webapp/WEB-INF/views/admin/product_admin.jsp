...
<script>
	...
	function insertProduct() {
		location.href="insertProductgo.do";
	};
					...
					<div class="col-10">
						...
						<div style="float: right;">
							<button type="button" class="btn btn-sm btn-dark"
								onclick="insertOption()">옵션추가</button>
							<button type="button" class="btn btn-sm btn-dark"
								onclick="optionList()">옵션목록</button>
							<button type="button" class="btn btn-sm btn-dark"
								onclick="insertProduct()">상품등록</button>
							<button type="button" class="btn btn-sm btn-dark"
								onclick="updateProduct()">상품수정</button>
							<button type="button" class="btn btn-sm btn-dark"
								onclick="deleteProduct()">상품삭제</button>
						</div>
						<form action="insertOption.do" style="margin-bottom: 50px;">
							...
							<table class="extable" style="width: 100%;">
								...
								<c:forEach var="list" items="${productList }">
									<tr style="text-align: center;">
										<td><input type="checkbox" value="${list.productnum }"
											id="checkbox" name="productnum"></td>
										...
										<td><a
											...
											style="color: black; text-decoration: none;"> <b>${list.productname }</b>
										</a></td>
