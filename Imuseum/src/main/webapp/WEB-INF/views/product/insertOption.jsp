...
<%@include file="/common/main.jspf"%>
	<article>
		<div class="container" role="main" style="margin-bottom: 20px; margin-top: 20px;">
			<h2>Option Insert Form</h2>
			<form name="form" id="form" role="form" method="get"
				action="insertOption.do">
				<div class="mb-3">
				<div class="mb-3">
					...
					<label for="reg_id">상품번호</label> <input type="text"
						class="form-control" name="productnum" id="title" readonly="readonly"
						value="${product.productnum }">
				</div>
				<div class="mb-3">
					<label for="reg_id">옵션</label> <input type="text"
						class="form-control" name="optionname" id="reg_id">
				</div>
				<div class="mb-3">
					<label for="reg_id">수량</label> <input type="number"
						class="form-control" name="cnt" id="reg_id">
				</div>
				<button class="btn btn-sm btn-primary" id="btnSave" style="background-color: gray; border-color: gray;">옵션추가</button>
