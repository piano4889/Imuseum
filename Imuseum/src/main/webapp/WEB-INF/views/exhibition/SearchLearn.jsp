...
<div class="container-fulid notosanskr">
	...
	<ul class="nav justify-content-center" id="searchnav">
		...
		<li class="nav-item">
			<a class="nav-link" href="searchLearn.do?searchKeyword=<%=search %>" style="border-bottom:1px solid black; border-bottom-width:thick; padding-bottom:20px;">
				LEARN ${learnList.size() }
			</a>
		</li>
	</ul>
	</div>
