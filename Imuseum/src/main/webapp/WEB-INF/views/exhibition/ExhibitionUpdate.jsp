...
<head>
<meta charset="UTF-8">
<title>IMUSEUM - EXHIBITION 수정</title>
	...
	<div class="container-fulid notosanskr">
		<div class="row" style="padding: 0; margin: 0;">
			<div class="col-8 offset-2" style="padding: 100px 0;">
				<div class="inputarea">
					<p style="font-size: 3em; font-weight: bold; margin-left: 10px;">전시수정</p>
					<hr>
					<form name="thisForm" action="exhibitionUpdateGo.do" method="post" enctype="multipart/form-data">
					<div class="box3">
							<span style="font-size: 40px; font-weight: bold;">
								<input type="text" placeholder="전시명을 입력해주세요." name="exhName" id="exhName" value="${evo.exhName}"
									style="margin-bottom: 20px; font-weight: bold;" required>
							</span><br>
							<span style="font-size: 20px; margin-top: 20px;">
								<input type="text" placeholder="전시소개글을 입력해주세요." name="exhInfo" id="exhInfo" value="${evo.exhInfo}"
							...
							<table style="width: 100%;" >
								<tr>
									...
									<td width="35%">
									<input type="date" name="startDate" id="startDate" value="${evo.startDate.substring(0,10)}" onchange="lastchk()" required>
									</td>
									<th width="15%">전시마감일</th>
									<td width="35%">
									<input type="date" name="lastDate" id="lastDate" value="${evo.lastDate.substring(0,10)}" required>
									</td>
								</tr>
								<tr>
									<th>장르</th>
									<td><input type="text" placeholder="장르를 입력하세요." name="genre" id="genre" value="${evo.genre}"></td>
									<th>후원처</th>
									<td><input type="text" placeholder="후원처를 입력하세요." name="partnership" id="partnership" value="${evo.partnership}"></td>
								</tr>
								<tr>
									<th>상단이미지</th>
									<td style="height: 100%;">
									...
									<td colspan="2">
										<c:if test="${not empty evo.upImg}">
										<img id="up_container" style="width: 500px; max-height:500px; object-fit:contain;"
										src="${pageContext.request.contextPath}/exhibitionImg/${evo.upImg }"
										/>
										</c:if>
										<img id="up_container" style="width: 500px; max-height:500px; object-fit:contain;"/>
									</td>
								...
								<tr>
									...
									<td colspan="2">
										<c:if test="${not empty evo.posterImg}">
										<img id="poster_container" style="width: 500px; max-height:500px; object-fit:contain;"
										src="${pageContext.request.contextPath}/exhibitionImg/${evo.posterImg }"/>
										</c:if>
										<img id="poster_container" style="width: 500px; max-height:500px; object-fit:contain;"/>
									</td>
								</tr>
								<tr>
									...
									<td colspan="2">
										<c:if test="${not empty evo.ticketImg}">
										<img id="ticket_container" style="width: 500px; max-height:500px; object-fit:contain;"
										src="${pageContext.request.contextPath}/exhibitionImg/${evo.ticketImg }"/>
										</c:if>
										<img id="ticket_container" style="width: 500px; max-height:500px; object-fit:contain;"/>
									</td>
								</tr>
								<tr>
									...
									<td colspan="2">
										<c:if test="${not empty evo.infoImg}">
										<img id="info_container" style="width: 500px; max-height:500px; object-fit:contain;"
										src="${pageContext.request.contextPath}/exhibitionImg/${evo.infoImg }"/>
										</c:if>
										<img id="info_container" style="width: 500px; max-height:500px; object-fit:contain;"/>
									</td>
								</tr>
						...
						<div id="layout4" style="float: right;">
							...
							<input type="hidden" name="upImg" value="${evo.upImg }">
							<input type="hidden" name="infoImg" value="${evo.infoImg }">
							<input type="hidden" name="posterImg" value="${evo.posterImg }">
							<input type="hidden" name="ticketImg" value="${evo.ticketImg }">
							<button class="btn btn-dark" id="btn" onclick="chk()">전시수정</button>
						</div>
					</form>	
				</div>
			</div>
