...
<div class="container-fulid notosanskr">
	...
	<ul class="nav justify-content-center" id="searchnav">
		<li class="nav-item">
			<a class="nav-link active" href="search.do?searchKeyword=<%=search %>">전체 ${exhibitionList.size()+learnList.size() }</a>
		</li>
		<li class="nav-item">
			<a class="nav-link" href="searchExhibition.do?searchKeyword=<%=search %>" style="border-bottom:1px solid black; border-bottom-width:thick; padding-bottom:20px;">
				EXHIBITION ${exhibitionList.size() }
			</a>
		</li>
		<li class="nav-item">
