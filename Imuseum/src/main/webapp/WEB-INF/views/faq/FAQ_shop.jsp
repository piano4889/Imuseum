		...
		<div class="container">
			<div class="cate">
				<ul class="cate nav justify-content-center" style="padding-top:40px;">
				  ...
				  <li class="nav-item">
				    <a class="nav-link active" id="shop" aria-current="page" href="#" onclick="location.href='FAQ_shop.do'" style="color:black;">뮤지엄샵·온라인 SHOP</a>
				  </li>
				  <li class="nav-item">
			...
			<div class="faq py-5">
			    <ul class="faqBody">
			        <li class="article" id="a1" style="border-top:2px solid black; padding-top:15px;">
			            <p class="q row"><a href="#a1" class="col-4">뮤지엄샵·온라인 SHOP</a><a href="#a1" class="col-8" style="color:black;">유아 동반 관람이 가능한가요?</a></p>
			        ...
			        <li class="article" id="a2" style="padding-top:15px;">
			            <p class="q row"><a href="#a2" class="col-4">뮤지엄샵·온라인 SHOP</a><a href="#a1" class="col-8" style="color:black;">입점 신청은 어떻게 하나요?</a></p>
			            <p class="a">
			        ...
			        <li class="article" id="a3" style="padding-top:15px;">
			            <p class="q row"><a href="#a3" class="col-4">뮤지엄샵·온라인 SHOP</a><a href="#a1" class="col-8" style="color:black;">신용카드나 현금영수증 발급이 가능한가요?</a></p>
			            <p class="a">
			        ...
			        <li class="article" id="a4" style="padding-top:15px;">
			            <p class="q row"><a href="#a4" class="col-4">뮤지엄샵·온라인 SHOP</a><a href="#a1" class="col-8" style="color:black;">구매한 상품을 반품하려면 어떻게 하면 되나요?</a></p>
			            <p class="a">
			        ...
			        <li class="article" id="a5" style="border-bottom: 1px solid #bdbdbd; padding-top:15px;">
			            <p class="q row"><a href="#a5" class="col-4">뮤지엄샵·온라인 SHOP</a><a href="#a1" class="col-8" style="color:black;">온라인으로 주문한 상품의 배송지를 변경할 수 있나요?</a></p>
			            <p class="a">
			        ...
			        <li class="article" id="a5" style="border-bottom: 1px solid #bdbdbd; padding-top:15px;">
			            <p class="q row"><a href="#a5" class="col-4">뮤지엄샵·온라인 SHOP</a><a href="#a1" class="col-8" style="color:black;">매장에서 상품을 구매하고 택배로 받아볼 수도 있나요?</a></p>
			            <p class="a">
							[뮤지엄샵] <br>
							매장에서 구매하신 상품은 반드시 구매 당시 수령해가셔야 합니다. <br>
							택배 배송을 원하시는 회원님들께서는 온라인샵을 이용해 주세요. <br><br>
							[온라인샵] <br>
							온라인샵에서 오후 2시까지 결제 확인된 주문에 대해서는 당일 출고를 진행하고 있습니다. 
						</p>
			        </li>
			        <li class="article" id="a5" style="border-bottom: 1px solid #bdbdbd; padding-top:15px;">
			            <p class="q row"><a href="#a5" class="col-4">뮤지엄샵·온라인 SHOP</a><a href="#a1" class="col-8" style="color:black;">현금영수증 / 신용카드 영수증 발급이 가능한가요?</a></p>
			            <p class="a">
							[뮤지엄샵] <br>
							매장에서 구매하신 상품은 반드시 구매 당시 수령해가셔야 합니다. <br>
							택배 배송을 원하시는 회원님들께서는 온라인샵을 이용해 주세요. <br><br>
